//
//  UDHNetworkHttpSessionManager.h
//  UDHNetworking
//
...
@interface UDHNetworkHttpSessionManager : NSObject
...
@property(strong,nonatomic)id<UDHNetworkURLRequestSerialization> requestSerializer;
@property(strong,nonatomic)id<UDHNetworkResponseSerialization> responseSerializer;
